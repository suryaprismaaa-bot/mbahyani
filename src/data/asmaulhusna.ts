...
export const ASMAUL_HUSNA: AsmaulHusnaItem[] = [
  ...
  { urutan: 5, arab: "السَّلاَمُ", latin: "As Salam", arti: "Yang Maha Memberi Kesejahteraan" },
  { urutan: 6, arab: "الْمُؤْمِنُ", latin: "Al Mu'min", arti: "Yang Maha Memberi Keamanan" },
  { urutan: 7, arab: "الْمُهَيْمِنُ", latin: "Al Muhaymin", arti: "Yang Maha Menguasai" },
  ...
  { urutan: 15, arab: "الْقَهَّارُ", latin: "Al Qahhar", arti: "Yang Maha Menundukkan" },
  ...
  { urutan: 25, arab: "الْمُذِلُّ", latin: "Al Mudzill", arti: "Yang Maha Menghinakan" },
  ...
  { urutan: 33, arab: "الْعَظِيمُ", latin: "Al 'Adhim", arti: "Yang Maha Agung" },
  { urutan: 34, arab: "الْغَفُورُ", latin: "Al Ghafur", arti: "Yang Maha Pengampun" },
  { urutan: 35, arab: "الشَّكُورُ", latin: "Asy Syakur", arti: "Yang Maha Menerima Syukur" },
  ...
  { urutan: 38, arab: "الْحَفِيظُ", latin: "Al Hafidh", arti: "Yang Maha Memelihara" },
  { urutan: 39, arab: "الْمُقِيتُ", latin: "Al Muqit", arti: "Yang Maha Memberi Kecukupan" },
  { urutan: 40, arab: "الْحَسِيبُ", latin: "Al Hasib", arti: "Yang Maha Pembuat Perhitungan" },
  { urutan: 41, arab: "الْجَلِيلُ", latin: "Al Jalil", arti: "Yang Maha Mulia" },
  ...
  { urutan: 50, arab: "الشَّهِيدُ", latin: "Asy Syahid", arti: "Yang Maha Menyaksikan" },
  ...
  { urutan: 53, arab: "الْقَوِيُّ", latin: "Al Qawiyy", arti: "Yang Maha Kuat" },
  ...
  { urutan: 56, arab: "الْـحَمِيدُ", latin: "Al Hamid", arti: "Yang Maha Terpuji" },
  { urutan: 57, arab: "الْمُحْصِي", latin: "Al Muhshi", arti: "Yang Maha Merekap / Menghitung" },
  { urutan: 58, arab: "الْمُبْدِئُ", latin: "Al Mubdi'", arti: "Yang Maha Memulai" },
  { urutan: 59, arab: "الْمُعِيدُ", latin: "Al Mu'id", arti: "Yang Maha Mengembalikan Kejadian" },
  ...
  { urutan: 67, arab: "الاَحَدُ", latin: "Al Ahad", arti: "Yang Maha Esa" },
  { urutan: 68, arab: "الصَّمَدُ", latin: "As Shamad", arti: "Yang Maha Diperlukan" },
  ...
  { urutan: 72, arab: "الْمُؤَخِّرُ", latin: "Al Mu'akhir", arti: "Yang Maha Mengakhirkan" },
  { urutan: 73, arab: "الأوَّلُ", latin: "Al Awwal", arti: "Yang Maha Awal" },
  { urutan: 74, arab: "الآخِرُ", latin: "Al Akhir", arti: "Yang Maha Akhir" },
  { urutan: 75, arab: "الظَّاهِرُ", latin: "Adh Dhahir", arti: "Yang Maha Nyata" },
  { urutan: 76, arab: "الْبَاطِنُ", latin: "Al Bathin", arti: "Yang Maha Gaib" },
  ...
  { urutan: 80, arab: "التَّوَّابُ", latin: "At Tawwab", arti: "Yang Maha Penerima Tolbat" },
  { urutan: 81, arab: "الْمُنْتَقِمُ", latin: "Al Muntaqim", arti: "Yang Maha Pemberi Balasan" },
  { urutan: 82, arab: "الْعَفُوُّ", latin: "Al 'Afuw", arti: "Yang Maha Pemaaf" },
  { urutan: 83, arab: "الرَّؤُوفُ", latin: "Ar Ra'uf", arti: "Yang Maha Pengasih" },
  { urutan: 84, arab: "مَالِكُ الْمُلْكِ", latin: "Malikul Mulk", arti: "Yang Maha Memiliki Kerajaan" },
  { urutan: 85, arab: "ذُو الْجَلاَلِ وَالإكْرَامِ", latin: "Dzul Jalali Wal Ikram", arti: "Yang Maha Memiliki Kebesaran dan Kemuliaan" },
  ...
  { urutan: 91, arab: "الضَّارَّ", latin: "Ad Dhaar", arti: "Yang Maha Penimpa Kemudharatan" },
  { urutan: 92, arab: "النَّافِعُ", latin: "An Nafi'", arti: "Yang Maha Pemberi Manfaat" },
  { urutan: 93, arab: "النُّورُ", latin: "An Nuur", arti: "Yang Maha Menerangi" },
  { urutan: 94, arab: "الْهَادِي", latin: "Al Haadi", arti: "Yang Maha Pemberi Petunjuk" },
  { urutan: 95, arab: "الْبَدِيعُ", latin: "Al Badi'", arti: "Yang Maha Pencipta yang Tiada Bandingannya" },
  { urutan: 96, arab: "الْبَاقِي", latin: "Al Baaqii", arti: "Yang Maha Kekal" },
  { urutan: 97, arab: "الْوَارِثُ", latin: "Al Waarith", arti: "Yang Maha Pewaris" },
  { urutan: 98, arab: "الرَّشِيدُ", latin: "Ar Rasyiid", arti: "Yang Maha Pandai" },
  { urutan: 99, arab: "الصَّبُورُ", latin: "As Shabuur", arti: "Yang Maha Sabar" }
];
