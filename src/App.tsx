          ...
          <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
            ...
            >
              ...
              <button
                ...
                className="absolute top-3.5 right-3.5 p-1.5 rounded-full text-slate-800 hover:text-black hover:bg-slate-100 cursor-pointer transition-colors active:scale-90"
                aria-label="Tutup"
              >
              ...
              <div className="relative w-28 h-28 mx-auto my-3 flex items-center justify-center">
                ...
                <div className="relative w-24 h-24 bg-white rounded-full border-4 border-slate-950 flex flex-col items-center justify-center shadow-md">
                  {/* Spinning Dashed border track */}
                  <div 
                    className="absolute inset-0.5 rounded-full border-2 border-dashed border-emerald-600 animate-spin" 
                    style={{ animationDuration: '12s' }}
                  ></div>
                  
                  {/* Numeric Display */}
                  <span className="text-4xl font-black text-slate-950 tracking-tighter leading-none mt-1">
                    {modalTimeLeft}
                  </span>
                  
                  <span className="text-[9px] font-black uppercase tracking-widest text-slate-950 mt-0.5 animate-pulse">
                    Detik
                  </span>
                </div>
              </div>
